...
return (
  <div className='Dashboard w-full min-h-screen flex'>
      ...
      <div className='flex flex-col w-full text-gray-200 bg-gray-950'>
          ...
          <div>
            <h1 className='ml-6 text-3xl font-bold my-4 mb-8'>Announcements</h1>

            <div className='flex flex-col gap-4 mt-4 m-6'>
                  {
                      Updates.map((info,key)=>{
                          return(
                              <div key={key} className='bg-gray-800 rounded-lg text-sm p-5 px-3 text-white flex flex-row justify-between gap-3 border-2 border-solid border-gray-500 transition-all duration-300 hover:bg-gray-950 ' >
